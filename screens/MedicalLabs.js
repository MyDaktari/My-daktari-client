...
export default (props) => {
	const dets = [
		{
			name: "KEMRI Medical research",
			contact: "0712345678",
			location: "Waiyaki way building 4 fl 3",
		},
		{
			name: "Kenyatta Hospital Lab wing",
			contact: "0712345678",
			location: "Mama ngina street building 4 fl 3",
		},
		{
			name: "Mama Lucy Hospital Lab wing",
			contact: "0712345678",
			location: "Moi ave building 4 fl 3",
		},
		{
			name: "Nairobi west Hospital Lab wing",
			contact: "0712345678",
	...
	return (
		<Layout style={styles.parent}>
			<List data={dets} renderItem={RenderLabs} />
		</Layout>
	);
};
